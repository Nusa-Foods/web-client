...
export default function NusaRecipeCard() {
    return (
        <div className="bg-white p-6 rounded-md shadow-md max-w-sm mx-auto">
            ...
            <button
                className="bg-custom-brown-1 text-white font-medium py-2 px-4 rounded-md text-sm hover:bg-custom-brown-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                Save Recipe
            </button>
        </div>
    )
